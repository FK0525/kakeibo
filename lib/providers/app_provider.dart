...
class AppProvider extends ChangeNotifier {
  ...
  int _budgetForMonth(String key) => _monthlyMap[key]?.availableBudget ?? 0;
  ...
  int _spentForMonth(String key) => _expenses
      .where((e) => _monthKey(e.date) == key && !e.isIncome)
      .fold(0, (s, e) => s + e.selfAmount);
  ...
  int get remainingBudget =>
      _monthly.availableBudget + specialIncomeUsable + carryoverAmount - totalSpent;
  ...
  double get budgetUsageRatio {
    final budget =
        _monthly.availableBudget + specialIncomeUsable + carryoverAmount;
